...
import { Building2, ArrowRight, AlertOctagon } from "lucide-react";
import {
...
export default async function DepartamentosPage({
  ...
  const [project, moduleCatalog, persons] = await Promise.all([
  ...
  const entityItems = project.entities.map((e) => ({
    id: e.id,
    name: e.name,
    type: e.type,
    identifier: e.identifier,
    notes: e.notes,
    departmentsCount: e.departments.length,
  }));
                ...
                <div className="flex items-center gap-3">
                  ...
                  <EntityAdminMenu
                    entity={{
                      ...
                      notes: entity.notes,
                      departmentsCount: entity.departments.length,
                    }}
                  />
                </div>
              </div>
